      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            Open to full-time AI/ML engineering roles. Have a project in mind or want to
            build something with AI together? Let&apos;s connect.
          </p>
          <a
            href="mailto:burhantin2005@gmail.com"
            className="text-md text-purple-400 hover:text-purple-300 transition-colors"
          >
            burhantin2005@gmail.com
          </a>
        </div>
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://github.com/Burhan2753Y"
            target="_blank"
          ...
          <Link
            href="https://in.linkedin.com/in/burhan2753y"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="LinkedIn"
          ...
          <Link
            href="https://www.instagram.com/burhan2753y/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all overflow-hidden"
